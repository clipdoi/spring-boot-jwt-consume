...
public class TestController {
	...
	private static final String REGISTRATION_URL = "http://localhost:9596/api/auth/signup";
	private static final String AUTHENTICATION_URL = "http://localhost:9596/api/signin";
	private static final String HELLO_URL = "http://localhost:9596/api/test/user";
